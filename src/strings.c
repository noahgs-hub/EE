...
const u8 gText_DexIntlTitle[] = _("INTERNAT'L DEX");
...
const u8 gText_DexIntlDescription[] = _("International edition POKéDEX");
...
const u8 gText_ShinyAnim[] = _("SHINY ANIM");
const u8 gText_ShinyProtect[] = _("SHINY PROTECT");
const u8 gText_GameSpeed[] = _("GAME SPEED");
...
const u8 gText_GameSpeedNormal[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}NORMAL");
const u8 gText_GameSpeed2x[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}2X");
const u8 gText_GameSpeed3x[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}3X");
