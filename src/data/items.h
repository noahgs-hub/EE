...
// Ability Modifiers
    ...
    [ITEM_ABILITY_CAPSULE] =
    {
        ...
        .price = 10000, // Sold by the Slateport market Ability Clerk
        .holdEffectParam = 0,
        .description = COMPOUND_STRING(
            "Switches a Poké-\n"
            "mon's ability."),
    ...
    [ITEM_ABILITY_PATCH] =
    {
        ...
        .price = 20000, // Sold by the Slateport market Ability Clerk
        .holdEffectParam = 0,
        .description = COMPOUND_STRING(
            "Turns the ability\n"
            "of a Pokémon into\n"
