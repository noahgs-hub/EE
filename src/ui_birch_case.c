...
{
    [BALL_TOP_FIRST]        = {SPECIES_MUDKIP, 5, WATER_STARTER, ITEM_POTION, BALL_POKE, NATURE_RANDOM, 1, MON_GENDER_RANDOM, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_TACKLE, MOVE_GROWL, MOVE_WATER_GUN, MOVE_BITE}, 0, 0, 0},
    [BALL_TOP_SECOND]       = {SPECIES_TREECKO, 5, GRASS_STARTER, ITEM_POTION, BALL_POKE, NATURE_RANDOM, 1, MON_GENDER_RANDOM, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_SCRATCH, MOVE_GROWL, MOVE_WATER_GUN, MOVE_BITE}, 0, 0, 0},
    [BALL_MIDDLE_FIRST]     = {SPECIES_TORCHIC, 5, FIRE_STARTER, ITEM_POTION, BALL_POKE, NATURE_RANDOM, 1, MON_GENDER_RANDOM, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_SCRATCH, MOVE_GROWL, MOVE_WATER_GUN, MOVE_BITE}, 0, 0, 0},

    [BALL_TOP_THIRD]        = {SPECIES_MAREEP, 5, GRASS_STARTER, ITEM_DRAGON_SCALE, BALL_POKE, NATURE_RANDOM, 1, MON_GENDER_RANDOM, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_TACKLE, MOVE_GROWL, MOVE_THUNDER_SHOCK, MOVE_TRAILBLAZE}, 0, 0, 0},
    [BALL_TOP_FOURTH]       = {SPECIES_HORSEA, 5, WATER_STARTER, ITEM_POTION, BALL_POKE, NATURE_RANDOM, 1, MON_GENDER_RANDOM, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_WATER_GUN, MOVE_CLEAR_SMOG, MOVE_SMOKESCREEN, MOVE_LEER}, 0, 0, 0},
