...
enum __attribute__((packed)) Item
{
    ...
    ITEM_TM331 = 1114,
    ITEM_TM332 = 1115,
                      // TM185-332: the all-time TM set. 967 is ITEM_POKEMON_BOX_RS,
                      // so these start at 968; no existing item id (0-967) shifts.
    ...
    // NUMBERS_512: the all-time TM set is 332 entries, past NUMBERS_256's range.
    RECURSIVELY(R_ZIP(ENUM_TM, TO_TMHM_NUMS NUMBERS_512, (FOREACH_TM(APPEND_COMMA))))
    ...
    ITEMS_COUNT = 1116, // TM185-332 occupy 968-1115 (332 TMs + 8 HMs = every all-time TM)
