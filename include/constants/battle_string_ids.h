...
enum StringID
{
    ...
    STRINGID_NUCLEARFUSIONENTERS,
    STRINGID_NUCLEARFUSIONCHARGES,
    STRINGID_NUCLEARFUSIONUNLEASHED,
    STRINGID_ORBITINGENTERS,
    STRINGID_FERMENTHPGAIN,
    STRINGID_COUNT
};
...
enum SwitchInAbilityStringID
{
    ...
    B_MSG_SWITCHIN_NUCLEAR_FUSION,
    B_MSG_SWITCHIN_ORBITING,
};
