...
#define VAR_SLATEPORT_ARTUR_STONE_INDEX                  0x404E
...
#define VAR_SLATEPORT_DIEGO_STATE                       0x409B // Slateport Diego event: 1 = complete
...
#define VAR_DEXNAV_STEP_COUNTER                          0x40DC // DexNav hidden mon step counter
...
#define VAR_BATTLE_SPEED                                 0x40FF // Battle speed setting (0-3 for 1x/2x/3x/4x); reuses unused var so vars[] size (and save layout) is unchanged
