...
enum
{
    ...
    OBJ_EVENT_GFX_CAMERAMAN_FRLG,
    OBJ_EVENT_GFX_UNUSED_WOMAN_FRLG,
    OBJ_EVENT_GFX_UNUSED_MAN_FRLG,
    OBJ_EVENT_GFX_UNUSED_MALE_RECEPTIONIST_FRLG,
    OBJ_EVENT_GFX_ITEM_BALL_FRLG,
    NUM_OBJ_EVENT_GFX,
};
