...
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_BoosterEnergyDesc[];
...
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_BlackSludgeDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_LightClayDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_HeatRockDesc[];
...
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_StickyBarbDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_GrassySeedDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_MetronomeDesc[];
...
extern const u8 gText_DexIntlTitle[];
...
extern const u8 gText_DexIntlDescription[];
